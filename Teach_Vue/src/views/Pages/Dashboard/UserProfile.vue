      ...
      <table class="table">
        <thead class="thead-dark">
          <tr>
            ...
            <th class="text-center" width="16%">Idade</th>
            <th class="text-center" width="20%">Idiomas</th>
            <th class="text-center" width="20%">Dominínio sobre</th>
            <th class="text-center" width="20%">Quer aprender sobre</th>
        ...
        <tbody>
          <template v-for="objeto in sugestaoUsuarios">
            <tr>
              <th class="text-center" width="20%">{{objeto.nome}}</th>
              <th class="text-center" width="16%">{{calcula(objeto.dataNascimento)}}</th>
              <th
                class="text-center"
                width="20%"
              >{{objeto.idiomaOrigem.descricao}}, {{objeto.idiomaParaAprender.descricao}} e {{objeto.idiomaFluenteSecundario.descricao}}</th>
              <th
                class="text-center"
                width="20%"
              >{{objeto.areaEstudoDominioGeral.descricao}} - {{objeto.areaEstudoDominioEspecifica.descricao}}</th>
              <th
                class="text-center"
                width="20%"
